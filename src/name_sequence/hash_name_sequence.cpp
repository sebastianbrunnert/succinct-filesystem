 ...
 */
class HashNameSequenceStrategy : public NameSequence {
private:
    std::unordered_map<size_t, std::string> names;

public:
    HashNameSequenceStrategy() : names() {}
...
template <>
NameSequence* create_name_sequence<HashNameSequenceStrategy>() {
    return new HashNameSequenceStrategy();
}