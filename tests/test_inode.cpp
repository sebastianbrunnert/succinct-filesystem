...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        std::function<InodeManager*(AllocationManager*)>([](AllocationManager* allocation_manager) { return create_inode_manager<HierarchyInodeManagerStrategy>(allocation_manager); })
    )
);
